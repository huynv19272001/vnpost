...
@Data
@Entity
@Table(name = "bao_gia_duong_bo_quoc_te")
public class BaoGiaDuongBoQuocte extends BaseEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "duongBoQuocTe_id", nullable = false)
    @JsonIgnore
    private DuongBoQuocTe duongBoQuocTe;
}
