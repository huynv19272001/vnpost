...
@Data
@Entity
@Table(name = "bao_gia_duong_sat_quoc_te")
public class BaoGiaDuongSatQuocte extends BaseEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "duongSatQuocTe_id", nullable = false)
    @JsonIgnore
    private DuongSatQuocTe duongSatQuocTe;
}
