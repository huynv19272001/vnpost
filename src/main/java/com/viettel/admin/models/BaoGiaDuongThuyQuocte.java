...
@Data
@Entity
@Table(name = "bao_gia_duong_thuy_quoc_te")
public class BaoGiaDuongThuyQuocte extends BaseEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "duongthuyQuocte_id")
    private DuongThuyQuocTe duongthuyQuocte;
}
