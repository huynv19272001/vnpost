...
@Data
@Entity
@Table(name = "duong_bo_noi_dia")//Đường thủy nội bộ nguyên chuyến
public class DuongBoNoiDia extends BaseEntity {
    ...
    @OneToMany(mappedBy = "duongBoNoiDia")
    private List<BaoGiaDuongBoNoiDia> baoGiaDuongBoNoiDias;
}