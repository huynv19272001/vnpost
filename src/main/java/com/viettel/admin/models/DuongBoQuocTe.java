...
@Data
@Entity
@Table(name = "duong_bo_quoc_te")
public class DuongBoQuocTe extends BaseEntity {
    ...
    @OneToMany(mappedBy = "duongBoQuocTe")
    private List<BaoGiaDuongBoQuocte> baoGiaDuongBoQuoctes;
