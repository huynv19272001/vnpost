...
@Data
@Entity
@Table(name = "duong_thuy_noi_dia")//Đường thủy nội bộ nguyên chuyến
public class DuongThuyNoiDia extends BaseEntity {
    ...
    private LocalDate thoiGianVanChuyen;
    ...
    @OneToMany(mappedBy = "duongThuyNoiDia")
    private List<BaoGiaDuongThuyNoiDia> duongThuyNoiDias;
