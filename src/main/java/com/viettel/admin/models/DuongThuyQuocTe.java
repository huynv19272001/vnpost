...
@Data
@Entity
@Table(name = "duong_thuy_Quoc_te")
public class DuongThuyQuocTe extends BaseEntity {
    ...
    @OneToMany(mappedBy = "duongthuyQuocte")
    private List<BaoGiaDuongThuyQuocte> baoGiaDuongThuyQuoctes;
